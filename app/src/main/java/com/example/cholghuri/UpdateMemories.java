...
public class UpdateMemories extends AppCompatActivity {
    ...
    private String tourID,userID,Id,UploadID,Caption,UploadURI;
    ...
    private void getDataFromIntent() {
        ...
        UploadURI = intent.getStringExtra("UploadURI");
        ...
        memoriesSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (uploadTask != null && uploadTask.isInProgress()) {
                    Toast.makeText(UpdateMemories.this, "Upload In Progress", Toast.LENGTH_SHORT).show();
                } else {
            ...
            uploadTask = fileReference.putFile(imageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(final UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(UpdateMemories.this, "Upload successfull", Toast.LENGTH_SHORT).show();
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(UpdateMemories.this, e.getMessage(), Toast.LENGTH_SHORT).show();
